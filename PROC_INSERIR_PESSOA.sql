...
BEGIN
    ...
    PROC_INSERIR_PESSOA(10, 'JOAO SILVA', 3500, 'joao@email.com', V_SAIDA);
    DBMS_OUTPUT.PUT_LINE('Inserido JOAO - Retorno: ' || V_SAIDA);

    PROC_INSERIR_PESSOA(11, 'MARIA SOUZA', 4200.50, 'maria@email.com', V_SAIDA);
    DBMS_OUTPUT.PUT_LINE('Inserido MARIA - Retorno: ' || V_SAIDA);

    PROC_INSERIR_PESSOA(12, 'CARLOS LIMA', 2800, 'carlos@email.com', V_SAIDA);
    DBMS_OUTPUT.PUT_LINE('Inserido CARLOS - Retorno: ' || V_SAIDA);

    PROC_INSERIR_PESSOA(13, 'ANA PEREIRA', 5100.75, 'ana@email.com', V_SAIDA);
    DBMS_OUTPUT.PUT_LINE('Inserido ANA - Retorno: ' || V_SAIDA);

    PROC_INSERIR_PESSOA(14, 'FERNANDO COSTA', 6200, 'fernando@email.com', V_SAIDA);
